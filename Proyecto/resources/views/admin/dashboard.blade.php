...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <button class="bg-blue-50 text-blue-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-100 transition-colors duration-200">
                <i class="fas fa-plus-circle mr-2"></i>Agregar Técnico
            </button>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-gray-50 rounded-xl p-5 border border-gray-200 hover:border-blue-300 transition-colors duration-300">
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    ...
                    <button class="text-gray-600 hover:text-green-600 transition-colors duration-200">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="text-gray-600 hover:text-red-600 transition-colors duration-200">
