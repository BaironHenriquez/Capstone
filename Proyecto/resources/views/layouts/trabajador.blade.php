...
<head>
    ...
    <title>@yield('title', 'Panel Trabajador') - TechService Pro</title>
    ...
    <!-- CSS personalizado para trabajadores -->
    <style>
        @keyframes slideInUp {
            from {
                opacity: 0;
        ...
        /* Colores específicos para trabajadores */
        .worker-primary { background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); }
        .worker-accent { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
    </style>
...
<body class="bg-gray-50 font-sans">
    ...
    <!-- Navigation Header -->
    <nav class="bg-gradient-to-r from-green-700 to-teal-700 shadow-lg sticky top-0 z-50">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-10 md:flex md:space-x-8">
                        ...
                        <a href="{{ route('ordenes.mis-tareas') }}" class="text-white hover:text-gray-200 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-300 {{ request()->routeIs('ordenes.mis-tareas') ? 'bg-white bg-opacity-20' : '' }}">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        <button class="text-white hover:text-gray-200 p-2 rounded-full transition-colors duration-300">
                            ...
                            <span class="absolute -top-1 -right-1 bg-orange-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">1</span>
                        </button>
                    </div>
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="hidden sm:block text-white text-sm">
                            <div class="font-semibold">{{ auth()->user()->name ?? 'Trabajador' }}</div>
                            <div class="text-xs text-gray-200">Panel Trabajador</div>
                        </div>
        ...
        <!-- Menú móvil -->
        <div id="mobile-menu" class="md:hidden bg-green-800 border-t border-green-600 hidden">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="{{ route('ordenes.mis-tareas') }}" class="text-white hover:text-gray-200 block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('ordenes.mis-tareas') ? 'bg-white bg-opacity-20' : '' }}">
    ...
    <footer class="bg-white border-t border-gray-200 mt-12">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="text-center text-sm text-gray-500">
                <p>&copy; 2025 TechService Pro - Panel Trabajador</p>
    ...
    <script>
        ...
        // Función para mostrar notificaciones trabajador
        function showWorkerNotification(message, type = 'info') {
            ...
            notification.className = `fixed top-20 right-4 z-50 p-4 rounded-lg shadow-lg ${
                ...
                type === 'warning' ? 'bg-yellow-500' : 'bg-teal-500'
            } text-white`;
